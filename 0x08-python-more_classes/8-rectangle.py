...
class Rectangle:
    ...
    @classmethod
    def __del__(cls):
        """Reduces the number of instances and
        prints a message after deleting an instance
    ...
    @staticmethod
    def bigger_or_smaller(rect_1, rect_2):
        """Compares 2 rectangles and returns the larger of the two

        Args:
            rect_1 (Rectangle object): the first rectangle
            rect_2 (Rectangle object): the second rectangle

        Raises:
            TypeError: if rect_1 or rect_2 is not isinstance of cls

        Returns:
            The larger between the 2
        """
